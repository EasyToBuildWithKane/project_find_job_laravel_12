<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="{{ route('admin.dashboard') }}" class="nav-link"><i class="fas fa-tachometer-alt"></i> <span>Bảng
            ...
            <li class="dropdown">
                <a href="#" class="nav-link has-dropdown"><i class="fas fa-briefcase"></i> <span>Tin tuyển
                        dụng</span></a>
                <ul class="dropdown-menu">
                    <li><a href="#">Tất cả tin</a></li>
                    <li><a href="#">Chờ duyệt</a></li>
                    <li><a href="#">Đã hết hạn</a></li>
                    <li><a href="#">Ngành nghề</a></li>
                    <li><a href="#">Loại hình công việc</a></li>
                    <li><a href="#">Địa điểm làm việc</a></li>
                </ul>
            </li>
            <li><a href="#"><i class="fas fa-tasks"></i> <span>Quản lý Job Tags</span></a></li>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a href="#">Gói dịch vụ tuyển dụng</a></li>
        ...
        <div class="mt-4 mb-4 p-3 hide-sidebar-mini">
            <form action="{{ route('admin.profile.logouts') }}" method="POST" id="logoutForm">
                ...
                <button type="button" id="logoutBtn"
                    class="btn btn-danger btn-lg btn-block btn-icon-split shadow-sm">
