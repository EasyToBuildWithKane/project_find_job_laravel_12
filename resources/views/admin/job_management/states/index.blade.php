...
@section('admin-content')
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <div>
                <h2 class="section-title mb-1">Quản lý các tỉnh/bang tuyển dụng</h2>
                <p class="text-muted mb-0">
                    Tại đây bạn có thể xem và chỉnh sửa nội dung từng phần của Quản lý các tỉnh/bang tuyển dụng.
                </p>
            </div>
            ...
            <div>
                <a href="{{ route('admin.states.create') }}" class="btn btn-primary">
                    <i class="fas fa-plus me-1"></i> Thêm tỉnh/bang
                </a>
            </div>
        </div>
        ...
        <div class="card shadow-sm border-0 mt-3">
            ...
            <div class="card-body p-4">
                <div class="table-responsive">
                    <table id="states-table" class="table table-striped align-middle text-center">
        ...
        $(function () {
            ...
            $('#states-table').DataTable({
                ...
                columns: [
                    ...
                    { data: 'name', name: 'name' },
                    { data: 'country_name', name: 'country_name' }, // ✅ Đã sửa
                    {
                        data: 'action',
                        name: 'action',
                        orderable: false,
