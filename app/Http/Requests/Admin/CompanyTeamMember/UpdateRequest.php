...
namespace App\Http\Requests\Admin\CompanyTeamMember;
...
class UpdateRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'job_title.required' => 'Chức danh là bắt buộc.',
            ...
            'profile_image_url.url' => 'Ảnh đại diện phải là URL hợp lệ.',
            'profile_image_url.max' => 'Ảnh đại diện không được vượt quá :max ký tự.',
            ...
            'social_links.array' => 'Liên kết mạng xã hội phải là dạng mảng.',
